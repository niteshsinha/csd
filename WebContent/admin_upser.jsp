...
String SCType=request.getParameter("CType");
String SCDesc=request.getParameter("CDesc");
session.setAttribute("txtOldCType",SCType);
%>
...
<div id="content"> <!-- This is the 2nd div -> Content. -->
	<form  action="MiscSuccess?flag=UpSER" method="post" onsubmit="return CheckData()"> <!-- This is a form -->
	<table width="760" border="0">
  		<tr>
    		<td width="150"><label for="ques">Service</label></td>
    		<td><input type="text" name="txtPtype" id="txtPtype" value=<%=SCType %>><!--user name--></td>
  		</tr>
  		<tr>
    		<td width="150"><label for="ans">Basic Discription</label></td>
    		<td><input type="text" name="txtPdesc" id="txtPdesc" value=<%=SCDesc %>>  <!--address--></td>
  		</tr>
    </table>
